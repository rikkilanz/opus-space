    ...
    return (
        <footer>
            <div className="max-w-[1440px] mx-auto flex flex-row justify-evenly mt-20 mb-20">
                <div className="">
                    <Image 
                        className="w-[190px] mb-[24px]"
                        src={brandLogoHorizontalWhite}
                    />
                    <h3 className="font-epilogue font-semibold text-[35px] w-[500px]">Would you like to work with us? Let's work together.</h3>
                ...
                <div className="flex flex-col">
                    <div className="mb-[24px]">
                        <h3 className="font-epilogue font-semibold text-[30px]">Connect</h3>
                    </div>
                    <div className="flex flex-wrap gap-5 w-[300px]">
                        ...
                        <Link href={'#'} className="underline font-epilogue">Email us at: hello@opusspace.ca</Link>
                    </div>
                </div>
            </div>
